...
sudo scutil --set ComputerName "bxbk"
sudo scutil --set HostName "bxbk"
sudo scutil --set LocalHostName "bxbk"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "bxbk"
